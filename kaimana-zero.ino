...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// START CHARACTER PROFILE SELECTION 
...
//instead of 8.
const Character* AllCharacters[NUM_CHARACTERS] = { &ryu, &ken, &terry, &akuma, &chun, &gief, &guile, &deeJay};


///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// END CHARACTER PROFILE SELECTION 
...
bool testForCharacterChange(void)
{
  ...
  bool bChangeComboHeld = digitalRead(PIN_TO_SWITCH_CHARACTER_1) == BUTTON_READ_CHECK &&
                          digitalRead(PIN_TO_SWITCH_CHARACTER_2) == BUTTON_READ_CHECK &&
                          digitalRead(PIN_TO_SWITCH_CHARACTER_3) == BUTTON_READ_CHECK &&
                          digitalRead(PIN_TO_SWITCH_CHARACTER_4) == BUTTON_READ_CHECK;
  ...
  if (bChangeComboHeld)
  {
    ...
    if (millis() -  ChangeComboHeldStart >= 1000) //1 second
    {
      ...
      {
        bChangeComboHeld = digitalRead(PIN_TO_SWITCH_CHARACTER_1) == BUTTON_READ_CHECK ||
                           digitalRead(PIN_TO_SWITCH_CHARACTER_2) == BUTTON_READ_CHECK ||
                           digitalRead(PIN_TO_SWITCH_CHARACTER_3) == BUTTON_READ_CHECK ||
                           digitalRead(PIN_TO_SWITCH_CHARACTER_4) == BUTTON_READ_CHECK;
...
*/
  ...
  {
    return true; //make sure Idle timer resets
  }
